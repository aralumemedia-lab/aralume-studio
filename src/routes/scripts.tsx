...
export const Route = createFileRoute("/scripts")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Roteiros e versões do pipeline editorial." },
    ],
  }),
  component: function ScriptsPage() {
    ...
    const q = useQuery({
      ...
      queryFn: () => getScripts(activeChannelId),
    });
    ...
    return (
      <div>
        <PageHeader
          eyebrow="Editorial"
          title="Roteiros"
          description="Roteiros com hook, promessa, CTA e histórico de versões."
        />
        <div className="p-4">
          <Card padded={false}>
            <CompactTable
