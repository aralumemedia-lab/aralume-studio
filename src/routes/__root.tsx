    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/dashboard"
            className="inline-flex items-center justify-center rounded-sm border border-border bg-surface px-3 h-8 text-xs font-medium text-foreground hover:bg-accent"
          >
            Ir para o Dashboard
          </a>
        </div>
  ...
  head: () => ({
    meta: [
      ...
      { title: "Aralume — Fábrica editorial multicanal com IA" },
      {
        name: "description",
        content:
          "Aralume é uma plataforma SaaS empresarial para operação de uma fábrica editorial multicanal baseada em agentes de IA, com governança, aprovação humana e rastreabilidade.",
      },
      ...
      { property: "og:title", content: "Aralume — Fábrica editorial multicanal com IA" },
      {
        ...
        content:
          "Operação editorial supervisionada por multiagentes, com governança e rastreabilidade.",
      },
