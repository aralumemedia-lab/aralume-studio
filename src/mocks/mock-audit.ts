...
export const mockAuditLogs: AuditLog[] = [
  {
    ...
    entityType: "HumanApproval",
    entityId: "ap_04",
    status: "success",
    message: "Publicação de 'A logística do Império Romano' aprovada.",
  ...
  },
  {
    ...
    channelId: "ch_historia",
    actorType: "agent",
    actorName: "Publicador",
    action: "publication.scheduled",
    entityType: "PublicationJob",
    entityId: "pj_02",
    status: "success",
    message: "Corte agendado para 13/07 12:00.",
  ...
  },
  {
    ...
    actorType: "agent",
    actorName: "Conformidade",
    action: "compliance.blocked",
    entityType: "Content",
    entityId: "idea_04",
    status: "warning",
    message: "Bloqueio aplicado — claim sem fonte primária.",
  ...
  },
  {
    ...
    entityType: "Channel",
    entityId: "ch_curiosidades",
    status: "warning",
    message: "Custo mensal atingiu 94% do orçamento.",
  ...
  },
  {
    ...
    channelId: "ch_historia",
    actorType: "agent",
    actorName: "Editor de Vídeo",
    action: "video.render.completed",
    entityType: "VideoAsset",
    entityId: "vd_01",
    status: "success",
    message: "Render finalizado em 1080p.",
  ...
  },
  {
    ...
    entityType: "Channel",
    entityId: "ch_historia",
    status: "success",
    message: "Configuração de narração ajustada.",
  ...
  },
  {
    ...
    channelId: "ch_curiosidades",
    actorType: "agent",
    actorName: "Pesquisador",
    action: "research.completed",
    entityType: "ResearchSession",
    entityId: "rs_03",
    status: "warning",
    message: "Sessão encerrada com 3 claims de baixa confiança.",
