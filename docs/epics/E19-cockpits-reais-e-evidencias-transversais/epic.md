...
| --- | --- | --- | --- | --- | --- | --- |
| Dashboard real / R14-T01 | only mock | partial | implemented | existing, but not demonstrable | existing | mock-api still feeds the main flow |
| Agent Office real / R14-T02 | only mock | partial | implemented | existing, but not demonstrable | existing | mock-api still feeds the main flow |
| Evidence harness | absent | n/a | n/a | n/a | n/a | no dedicated reusable final-acceptance harness yet |
