...
| Sprint 18 (em execucao) | E17 - Pipeline Midia e Producao Operavel pelo Frontend | V1-09, V1-10 | R14-09, R14-10 | funcional + frontend + backend + integracao | render e cortes operaveis no frontend |
