...
| E-13 | Supplemental Sprint 21 evidence | `docs/acceptance/v1/V1_SPRINT21_EVIDENCE.md`, `scripts/sprint21-browser-e2e.mjs` and `screenshots/sprint-21/`.                                                                                         | Records E19 cockpit projections, reload, isolation, reusable browser states and visual proof without changing the official matrix or executing reaccept. |
