...
## H12.6 - estado corretivo

H12.6 esta em implementacao na Sprint 12 para materializar um `VideoAsset` novo
por fluxo oficial de storage. A Sprint 12 permanece bloqueada para validacao real
ate que o asset seja elegivel e o upload privado/nao listado seja reproduzido.

### H12.6 - validacao real concluida

- Data: 2026-07-15.
- O novo `VideoAsset` foi criado e usado em um job de publicacao real.
- O upload, a consulta, o replay idempotente, o isolamento e a revogacao foram
  comprovados.
