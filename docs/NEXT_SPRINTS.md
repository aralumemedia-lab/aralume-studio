...
| E12 | Publicacao Assistida          | Preparar publicacao com aprovacao humana, compliance e contratos seguros, sem envio externo automatico. | planned   | Aprovações, compliance, custos, modo operacional, video pronto e contratos de publicacao. | Pacote de publicacao pronto, sem envio externo automatico.     | S11                |
...
| E15 | Hardening V1.0                | Consolidar a base operacional demonstravel para V1.0.                                                   | planned   | Epicos anteriores concluídos e docs coerentes.                                            | Demonstracao ponta a ponta pelo frontend.                      | TBD                |
...
| H11.3 | E12   | Preparacao assistida de payload e agendamento             | P1         | `docs/specs/009-rendering.md`, `docs/specs/011-publication-assisted.md`                                                         | S11    | ready  |
